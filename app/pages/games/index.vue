...
<path style="fill:var(--p-surface-0);" d="M254,28.2C129.5,28.2,28.2,129.5,28.2,254S129.5,479.8,254,479.8S479.8,378.5,479.8,254
  ...
  <path style="fill:var(--p-dark-primary-900);" d="M248.605,123.475L224.88,147.2c-7.37,8.21-1.487,18.166,7.758,18.618h119.014
    ...
    <div class="flex flex-col items-center w-full" v-else>
      <GameCallToActionCard
          ...
          icon="pi-play-circle"
          @buttonClicked="router.push('/rooms/players/add')"
      >
        <template #icon>
          <svg height="5rem" width="5rem" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
               viewBox="0 0 392.598 392.598" xml:space="preserve">
<path style="fill:var(--p-dark-primary-300);" d="M120.469,49.455c0,15.257-12.412,27.669-27.669,27.669c-15.192,0-27.669-12.412-27.669-27.669
	S77.543,21.786,92.8,21.786C108.057,21.786,120.469,34.198,120.469,49.455z"/>
            <path style="fill:var(--p-surface-0);" d="M62.287,265.503h61.026v105.244h-19.588v-42.861c0-6.012-4.848-10.925-10.925-10.925
	c-6.012,0-10.925,4.849-10.925,10.925v42.861H62.287V265.503z"/>
            <path style="fill:var(--p-primary-500);" d="M144.129,181.657v62.061H41.471v-62.061c0-25.277,20.558-45.834,45.834-45.834h10.99
	C123.572,135.822,144.129,156.38,144.129,181.657z"/>
            <path style="fill:var(--p-surface-0);" d="M272.129,49.455c0-15.257,12.412-27.669,27.669-27.669c15.257,0,27.669,12.412,27.669,27.669
	s-12.412,27.669-27.669,27.669C284.606,77.123,272.129,64.711,272.129,49.455z"/>
            <path style="fill:var(--p-primary-500);" d="M269.156,265.503h61.026v105.244h-19.523v-42.861c0-6.012-4.848-10.925-10.925-10.925
	c-6.077,0-10.925,4.849-10.925,10.925v42.861h-19.653L269.156,265.503L269.156,265.503z"/>
            <path style="fill:var(--p-dark-primary-300);" d="M351.127,181.657v62.061H248.469v-62.061c0-25.277,20.558-45.834,45.834-45.834h10.99
	C330.57,135.822,351.127,156.38,351.127,181.657z"/>
            <g>
	<path style="fill:var(--p-dark-primary-900);" d="M98.295,113.972h-10.99c-37.301,0-67.685,30.384-67.685,67.685v72.921
		...
		v42.861H62.287V265.503h61.026L123.378,370.747L123.378,370.747z"/>
              <path style="fill:var(--p-dark-primary-900);" d="M92.8,0C65.519,0,43.281,22.174,43.281,49.455s22.174,49.455,49.455,49.455
		...
		s27.669,12.412,27.669,27.669S108.057,77.123,92.8,77.123z"/>
              <path style="fill:var(--p-dark-primary-900);" d="M305.228,113.972h-10.99c-37.301,0-67.685,30.384-67.685,67.685v72.921
		...
		V265.503h61.026v105.244H330.311z"/>
              <path style="fill:var(--p-dark-primary-900);" d="M299.798,0c-27.281,0-49.455,22.174-49.455,49.455s22.174,49.455,49.455,49.455
